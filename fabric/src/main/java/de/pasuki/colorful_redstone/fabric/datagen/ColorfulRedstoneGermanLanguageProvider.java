...
public class ColorfulRedstoneGermanLanguageProvider implements DataProvider {
    private final PackOutput.PathProvider languageFiles;

    public ColorfulRedstoneGermanLanguageProvider(FabricDataOutput output) {
    ...
    public CompletableFuture<?> run(CachedOutput writer) {
        ...
        for (DyeColor color : ModBlocks.supportedColors()) {
            ...
            String blockName = ModLanguageEntries.germanBlockName(color);
